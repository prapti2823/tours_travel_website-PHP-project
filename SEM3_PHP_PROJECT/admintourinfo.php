...
if (isset($_POST['submit'])) {
  ...
  echo "<script>alert('Detail Information Created Successfully')</script>";
}
      ...
      <div class="container-fluid">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb my-0 ms-2">
            ...
            <li class="breadcrumb-item active"><span>Tour Details</span></li>
          </ol>
        </nav>
      </div>
    </header>
        ...
        <div class="row">
          <div>
            <form method="POST" enctype="multipart/form-data">
              ...
              <div>
                <input type="file" name="tourimg1" required>
              </div>
              <div>
                <input type="file" name="tourimg2" required>
              </div>
              <div>
                <input type="file" name="tourimg3" required>
              </div>
              <div>
                Enter package name <input type="text" name="tourname" required>
              </div>
              <div>
                Enter package details<textarea name="tourinfo" required></textarea>
              </div>
              <div>
                Enter no of days<input type="text" name="tourdays" required>
              </div>
              <div>
                Enter package price<input type="text" name="tourprice" required>
              </div>
              <div class="row">
