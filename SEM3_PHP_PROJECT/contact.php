      ...
      <div class="container-fluid">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb my-0 ms-2">
            ...
            <li class="breadcrumb-item active"><span>Feedback</span></li>
          </ol>
        </nav>
      </div>
    </header>
              ...
              if (mysqli_num_rows($result) > 0) { ?>
                <table border="1" class="table">
                  ...
                  <tbody>
                    ...
                    $qry = "SELECT *FROM contact LIMIT " . $page_first_result . ',' . $results_per_page;
                    $result = mysqli_query($con, $qry);
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                      ...
                      echo "<td>";
                      echo '<a style="padding:5px;" href="readcontact.php?id=' . $row['id'] . '" class="mr-3" title="View Record" data-toggle="tooltip"><span class="fa fa-eye"></span></a>';
                      ...
                      echo '<a style="padding:5px;" href="deletecontact.php?id=' . $row['id'] . '" title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
                      echo "</td>";
                      echo "</tr>";
                    } ?>
                  </tbody>
                ...
                for ($page = 1; $page <= $number_of_page; $page++) {
                  echo '<a href = "contact.php?page=' . $page . '" style="text-decoration:none;">' . $page . ' </a>';
                }
