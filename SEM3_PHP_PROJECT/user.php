            ...
            if ($result = mysqli_query($con, $sql)) {
              if (mysqli_num_rows($result) > 0) { ?>
                <table border="1" class="table">
                  ...
                  <tbody>
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                      ...
                      echo "<td>";
                      echo '<a style="padding:5px;" href="read.php?id=' . $row['id'] . '" class="mr-3" title="View Record" data-toggle="tooltip"><span class="fa fa-eye"></span></a>';
                      ...
                      echo '<a style="padding:5px;" href="delete.php?id=' . $row['id'] . '" title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
                      echo "</td>";
                      echo "</tr>";
                    }
                    ?>
                ...
                for ($page = 1; $page <= $number_of_page; $page++) {
                  echo '<a href = "user.php?page=' . $page . '" style="text-decoration:none;">' . $page . ' </a>';
                }
