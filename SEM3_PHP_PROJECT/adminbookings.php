  ...
  <div class="wrapper d-flex flex-column min-vh-100 bg-light">
      ...
      <div class="container-fluid">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb my-0 ms-2">
            ...
            <li class="breadcrumb-item active"><span>Bookings</span></li>
          </ol>
        </nav>
      </div>
    </header>
    ...
    <div class="body flex-grow-1 px-3" style="background-color:white;">
      <div class="container-lg">
        <div class="row">
          <h2 style="text-align: center;">Bookings Details</h2>
              ...
              if (mysqli_num_rows($result) > 0) {
                ...
                <table border="1" class="table">
                  ...
                  <tbody>
                    ...
                    $sql = "SELECT b.*, p.packname FROM bookings b JOIN packages p ON b.pack_id = p.packid LIMIT " . $page_first_result . ',' . $results_per_page;
                    $result = mysqli_query($con, $sql);
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                      ...
                      echo "<td>";
                      echo '<a style="padding:5px;" href="viewbookings.php?id=' . $row['id'] . '" class="mr-3" title="View Record" data-toggle="tooltip"><span class="fa fa-eye"></span></a>';
                      // echo '<a style="padding:5px;" href="update.php?id='. $row['id'] .'" class="mr-3" title="Update Record" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
                      echo '<a style="padding:5px;" href="deletebookings.php?id=' . $row['id'] . '" title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
                      "</td>";
                      echo "</tr>";
                    }
                    ?>
                ...
                for ($page = 1; $page <= $number_of_page; $page++) {
                  echo '<a href="adminbookings.php?page=' . $page . '" style="text-decoration:none;">' . $page . ' </a>';
                }
