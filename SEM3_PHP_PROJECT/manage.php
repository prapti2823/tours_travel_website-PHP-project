  ...
  <div class="wrapper d-flex flex-column min-vh-100 bg-light">
      ...
      <div class="container-fluid">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb my-0 ms-2">
            ...
            <li class="breadcrumb-item active"><span>Manage Packages</span></li>
          </ol>
        </nav>
      </div>
    </header>
    ...
    <div class="body flex-grow-1 px-3" style="background-color:white;">
      <div class="container-lg">
        <div class="row">
          <h2 style="text-align: center;">Packages Details</h2>
            ...
            if ($result = mysqli_query($con, $sql)) {
              if (mysqli_num_rows($result) > 0) { ?>
                <table border="1" class="table">
                  <thead>
                    <tr>
                      ...
                      <th>Package Image</th>
                      <th>Package Name</th>
                      <th>Package days | Cities</th>
                      <th>Places included in the package</th>
                      <th>Package Price</th>
                      <th>Action</th>
                    </tr>
                  </thead>
                  <tbody>
                    ...
                    $sql = "SELECT *FROM packages LIMIT " . $page_first_result . ',' . $results_per_page;
                    $result = mysqli_query($con, $sql);
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                      ...
                      echo "<td>" . $count . "</td>"; ?>
                      <td><img src="<?php echo $row['packimg'] ?>" height='100px' width='100px'></td>
                      <?php echo "<td>" . $row['packname'] . "</td>";
                      echo "<td>" . $row['packdays'] . "</td>";
                      echo "<td>" . $row['packplaces'] . "</td>";
                      echo "<td>" . $row['packprice'] . "</td>";
                      echo "<td>";
                      echo '<a style="padding:5px;" href="viewpack.php?packid=' . $row['packid'] . '" class="mr-3" title="View Record" data-toggle="tooltip"><span class="fa fa-eye"></span></a>';
                      echo '<a style="padding:5px;" href="edit.php?packid=' . $row['packid'] . '" class="mr-3" title="Update Record" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
                      echo '<a style="padding:5px;" href="deletepack.php?packid=' . $row['packid'] . '" title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
                      echo "</td>";
                      echo "</tr>";
                      $count++;
                    } ?>
                ...
                for ($page = 1; $page <= $number_of_page; $page++) {
                  echo '<a href = "manage.php?page=' . $page . '" style="text-decoration:none;">' . $page . ' </a>';
                }
