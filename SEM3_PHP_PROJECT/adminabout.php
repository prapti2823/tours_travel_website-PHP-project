        ...
        <li class="nav-item"><a class="nav-link" href="widgets.html">
            ...
            <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
                ...
                <ul class="nav-group-items">
                    ...
                    <li class="nav-item"><a class="nav-link" href="adminabout.php">About Us
                        </a></li>
                ...
                <div class="row">
                    <div>
                        ...
                        if (isset($_POST['submit'])) {
                            ...
                            $qry = "INSERT INTO about(aboutus) VALUES('$aboutus')";
                        ...
                        <form method="POST">
                            <div>
                                Enter package details<textarea name="aboutus" rows="50"></textarea>
                            </div>
